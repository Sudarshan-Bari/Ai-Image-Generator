  ...
  const generateImage = async () => {
    ...
    try {
      ...
      if (response.ok && data.imageUrl) {
        setImageUrl(data.imageUrl); // Update with the image URL returned from the backend
      } else {
        console.error('Error:', data.message || 'Failed to generate image');
      }
    } catch (error) {
        ...
        {imageUrl && (
          <div className="mt-8 w-full flex justify-center">
            <div className="relative max-w-lg w-full">
              <Image
                src={imageUrl} // Use Image component instead of img
                alt="Generated by AI"
                className="rounded-lg shadow-lg w-full h-auto"
                layout="responsive" // Optional: Use responsive layout for better image scaling
